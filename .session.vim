...
noremap <silent> <Plug>PipeToggle :PipeToggleWindow
noremap <silent> <Plug>PipeLast :PipeLast
...
silent only
silent tabonly
cd /mnt/magellan/Workspace/solenoid-engine
...
%argdel
$argadd src/App.js
$argadd src/components/Interface/index.js
$argadd src/components/Interface/Scene/index.js
set stal=2
tabnew
tabnew
tabrewind
...
wincmd w
argglobal
if bufexists("src/styles/Interface.scss") | buffer src/styles/Interface.scss | else | edit src/styles/Interface.scss | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> ,hp <Plug>(GitGutterPreviewHunk)
nmap <buffer> ,hu <Plug>(GitGutterUndoHunk)
...
exe 'vert 2resize ' . ((&columns * 119 + 119) / 238)
tabnext
edit src/components/Interface/index.js
set splitbelow splitright
wincmd t
set winminheight=0
set winheight=1
...
normal! 035|
tabnext
edit src/components/Interface/Scene/index.js
set splitbelow splitright
wincmd t
set winminheight=0
set winheight=1
...
set stal=1
badd +1 src/App.js
badd +0 src/components/Interface/index.js
badd +0 src/components/Interface/Scene/index.js
badd +12 src/components/Interface/Scene/Cube/index.js
badd +7 src/components/Interface/Camera/index.js
badd +6 src/styles/Interface.scss
