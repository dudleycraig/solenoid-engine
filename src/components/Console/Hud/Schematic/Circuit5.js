  ...
  return (
    <g ref={ref} id="circuit5" className="circuit svg-passive" {...props}>
      <g className="mosfet-pwm">
        <circle cx="0" cy="130" r="1" className="dot" />
        <path d="m 0,130 h 5" />
        <Pulse x="5" y="130" major={false} id="pulse-minor.circuit5" />
      </g>
      <Mosfet
        x="15"
        y="125"
      ...
      <g className="coil-pwm">
        <Pulse x="55" y="120" major={true} id="pulse-major.circuit5" />
        <Coil
          x="65"
          y="120"
          title="12V Solenoid #5"
        ...
        />
        <circle cx="150" cy="120" r="1" className="dot" />
      </g>
      <g className="supply-24v-bus-horizontal">
        <circle cx="140" cy="130" r="1" className={'dot'} />
        <circle cx="150" cy="120" r="1" />
        <path d="m 140,130 h 10" />
      </g>
      <g className="supply-24v-bus-vertical">
        <circle cx="150" cy="130" r="1" className="dot" />
      ...
      <g className="current-sensor-bus-horizontal">
        <path d="m 200,130 h 10" />
      </g>
      <g className="current-sensor-bus-vertical">
        <circle cx="200" cy="130" r="1" className="dot" />
      ...
      <g className="thermistor-bus-horizontal">
        <path d="m 112,130 h 10" />
        <path d="m 122,130 v 15" />
        <Bridge x="122" y="145" r="90" />
        <path d="m 122,155 v 5" />
      </g>
      <g className="thermistor-bus-vertical">
        <path d="m 122,160 v 15" />
        <path d="m 122,175 v 15" />
      </g>
      <g className="supply-5v-bus-horizontal">
        <path d="m 80,130 h 17" />
      </g>
