...
export default ({ x, y, title, paragraph, img, link, ...props }) => {
  return (
    <g transform={`translate(${x} ${y})`} id="reflective-encoder" {...props}>
      <path d="m 0,-2 h 5 v -10 h 10 v 10 h 10 v -10 h 10 v 10 h 5" />
      <path d="m 0,2 h 10 v 10 h 10 v -10 h 10 v 10 h 7" />
      <OverlayTrigger
        placement="top"
        overlay={
