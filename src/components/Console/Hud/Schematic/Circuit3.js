...
export default forwardRef((props, ref) => {
  ...
  return (
    <g ref={ref} id="circuit3" className="circuit svg-passive" {...props}>
      <g className="mosfet-pwm">
        <circle cx="0" cy="70" r="1" className="dot" />
        <path d="m 0,70 h 5" />
        <Pulse x="5" y="70" major={false} id="pulse-minor.circuit3" />
      </g>
      <Mosfet
        x="15"
        y="65"
      ...
      <g className="coil-pwm">
        <Pulse x="55" y="60" major={true} id="pulse-major.circuit3" />
        <Coil
          x="65"
          y="60"
          title="12V Solenoid #3"
        ...
        />
        <circle cx="150" cy="60" r="1" className="dot" />
      </g>
      <g className="supply-24v-bus-horizontal">
        <circle cx="140" cy="70" r="1" className="dot" />
        <circle cx="150" cy="60" r="1" />
        <path d="m 140,70 h 10" />
      </g>
      <g className="supply-24v-bus-vertical">
        <circle cx="150" cy="70" r="1" className="dot" />
      ...
      <g className="thermistor-bus-horizontal">
        <path d="m 112,70 h 14" />
        <path d="m 126,70 v 15" />
        <Bridge x="126" y="85" r="90" />
        <path d="m 126,95 v 5" />
      </g>
      <g className="thermistor-bus-vertical">
        <path d="m 126,100 v 15" />
        <Bridge x="126" y="115" r="90" />
        <path d="m 126,125 v 5" />

        <path d="m 126,130 v 15" />
        <Bridge x="126" y="145" r="90" />
        <path d="m 126,155 v 5" />

        <path d="m 126,160 v 30" />
      </g>
